<%-- 
    Document   : school
    Created on : 28-Mar-2017, 20:03:26
    Author     : Abdoulr
--%>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="school.jsp">School</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <div class="container">
                         <p>School List</p>
            <button type="button" class="btn btn-default btn-lg" data-toggle="modal" data-target="#myModal">Create a New School</button>
                    </div>
